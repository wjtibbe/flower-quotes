  ...
  return (
    <div className="space-y-6">
      ...
      <form className="card p-4 flex flex-wrap gap-3 items-end">
        ...
        {hasFilters && (
          <Link href="/settings/exchange-rates" className="text-xs text-brand-600 hover:underline pb-2">
            Filters wissen
          </Link>
        )}
      </form>
            ...
            {rows.map((r) => (
              <tr key={r.id}>
                ...
                <td className="whitespace-nowrap">
                  <a href={`/settings/exchange-rates?edit=${r.id}`} className="text-brand-600 hover:underline text-xs mr-3">
                    Aanpassen
                  </a>
        ...
        {editing ? (
          <form action={editExchangeRate.bind(null, editing.id)} key={editing.id} className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2 flex gap-2">
              ...
              <a href="/settings/exchange-rates" className="btn-secondary">Annuleren</a>
            </div>
          </form>
        ) : (
