...
describe("validatePriceLineInput", () => {
  ...
  it.each([
    ...
    ["MISSING_DDP_CLEARING", { ddp: { inspectionPerStem: 0.01, handlingPerBox: 2 } }],
    ["MISSING_DDP_INSPECTION", { ddp: { clearingPerStem: 0.02, handlingPerBox: 2 } }],
    ["MISSING_DDP_HANDLING", { ddp: { clearingPerStem: 0.02, inspectionPerStem: 0.01 } }],
